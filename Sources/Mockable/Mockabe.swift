...
public protocol Mockable {
    ...
    static func decodeFromFile<T: Decodable>(fileName: String, bundle: Bundle) throws -> T
...
public class MockManager: Mockable {
    ...
    public static func decodeFromFile<T: Decodable>(fileName: String, bundle: Bundle) throws -> T {
